...
# 4 "invertWorrdsInStr.c" 2


# 5 "invertWorrdsInStr.c"
void test();
...
void test()
{
    char str[30] = {'\0'};
    fgets(str, 30, 
# 58 "invertWorrdsInStr.c" 3 4
                  stdin
# 58 "invertWorrdsInStr.c"
                       );
    int x = strlen(str);
    invert(str,x-1);
    printf("\n%s",str);
